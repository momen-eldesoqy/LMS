    ...
    <div class="row">
      ...
      <div class="card" style="width: 35rem;">
       ...
       Book ID :  {{$id -> id}}
        ...
        <li class="list-group-item">Book Title : {{$id -> title}}</li>
        <li class="list-group-item">Price : {{$id -> price}}</li>
        <li class="list-group-item">Case : {{boolval($id -> available) ? 'available' : 'taken'}} </li>
