...
<body>
  ...
  <div class="container-fluid">
    ...
    <form action="update/{{$editid->id}}" method="POST" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-20">
          @csrf
        <div class="form-group">
          <label>Name</label>
        <input type="text" class="form-control" placeholder="First Name" name="name" value="{{$editid->name}}">
        </div>
          <div class="form-group">
            <label>Email</label>
            <input type="email" class="form-control" placeholder="email" name="email" value="{{$editid->email}}">
          </div>
          <div class="form-group">
            <label>address</label>
            <input type="text" class="form-control" placeholder="Address" name="address" value="{{$editid->address}}">
          </div>
          <div class="form-group">
