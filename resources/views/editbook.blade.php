...
<body>
  ...
  <div class="container-fluid">
    ...
    <form action="update/{{$editid->id}}" method="POST" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pt-20">
        ...
        <input type="text" class="form-control" placeholder="First Name" name="title" value="{{$editid->title}}">
        </div>
        <div class="form-group">
            <label>Price</label>
            <input type="text" class="form-control" placeholder="Last Name" name="price" value="{{$editid->price}}">
          </div>
          <div class="form-group">
