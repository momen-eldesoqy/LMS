    ...
    <div class="row">
      ...
      <div class="card" style="width: 35rem;">
        <div class="card-header text-center">
         Student ID:  {{$searchedstd -> id}}
        </div>
        <ul class="list-group list-group-flush">
        <li class="list-group-item">Name : {{$searchedstd -> name}}</li>
          <li class="list-group-item">Email : {{$searchedstd -> email}} </li>
          <li class="list-group-item">Address : {{$searchedstd -> address}} </li>
        </ul>
      </div>
